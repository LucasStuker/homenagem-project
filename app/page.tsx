        ...
        {showHearts && (
          <div className="pointer-events-none fixed inset-0 z-[999] overflow-hidden">
            {[
              ...
              { left: "20%", delay: "0.2s", size: "text-2xl" },
              { left: "35%", delay: "0.4s", size: "text-lg" },
              { left: "50%", delay: "0.1s", size: "text-3xl" },
              { left: "65%", delay: "0.3s", size: "text-xl" },
              { left: "78%", delay: "0.5s", size: "text-2xl" },
              { left: "90%", delay: "0.15s", size: "text-lg" },
            ].map((heart, index) => (
              <span
                key={index}
                className={`absolute bottom-0 ${heart.size} animate-float-heart`}
                style={{
                  left: heart.left,
        ...
        <section className="px-6 py-16 max-w-md mx-auto text-center border-t border-zinc-900 mt-8">
          ...
          <div className="space-y-4 text-zinc-400 text-sm leading-relaxed">
            <p>
              ...
              todos os dias. Eu acompanho de perto a sua garra, a sua
              resiliência e o coração gigante que você tem.
            </p>
            <p>
              Essas memórias aqui em cima são só uma parte da nossa história. A
              outra parte é a minha admiração por quem você é quando está
              buscando seus sonhos. Você é incrível, Aline.
            </p>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            <article className="bg-zinc-900/50 p-6 rounded-3xl border border-zinc-800 text-left shadow-xl backdrop-blur-sm relative hover:border-rose-800 transition-colors duration-300">
              ...
              <p className="text-zinc-100 text-sm mb-6 leading-relaxed">
                ...
                mais mesmo. A doida que eu mais amo nessa vida. A melhor
                parceira de todos os tempos! Superou todas as expectativas.
                Recomendo de olhos fechados (apenas pra mim) !
              </p>
            ...
            <article className="bg-zinc-900/50 p-6 rounded-3xl border border-zinc-800 text-left shadow-xl backdrop-blur-sm relative hover:border-rose-800 transition-colors duration-300">
              ...
              <p className="text-zinc-100 text-sm mb-6 leading-relaxed">
                ...
                eu dormir grudada e ainda acorda as 5 da manhã pra me dar
                comida. Claramente merece 5 estrelas.
              </p>
        ...
        >
          ...
          <div className="relative z-10 space-y-4 text-zinc-300 text-sm leading-relaxed">
            <p>
              ...
              fases, risadas, planos, desafios e percausos... o que faz tudo
              valer a pena é ter você comigo.
            </p>

            <p>
              Hoje é o seu dia, mas a verdade é que eu agradeço por você existir
              em todos eles. Pela sua força, pelo seu carinho, pela sua luz e
              por tudo que você é.
            </p>
          ...
          <div className="relative z-10 mt-10">
            <button
              onClick={() =>
                alert("Te amo, Mozão. Obrigado por viver comigo ❤️")
              }
